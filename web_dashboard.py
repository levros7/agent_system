...
class WebDashboard:
    def __init__(self, message_queue, port=5000):
        ...
        self.agent_status = {
            "WarLMTAgent":       {"running": True, "last_update": None, "message_count": 0, "last_data": "", "last_type": ""},
    ...
    def get_dashboard_html(self):
        ...
        <body>
            ...
            <script>
                const ALL_AGENTS   = ["WarDashboardAgent","WarWorkflowManager"];
                const WAR_AGENTS   = ["WarMissileTrackerAgent","WarFearGreedAgent","WarBTCAgent","WarSP500Agent","WarOilAgent","WarLMTAgent","WarNewsAgent","WarTelegramAgent"];
                const AGENT_ICONS  = {
                    WarDashboardAgent:"🌐", WarWorkflowManager:"⚙️", WarLMTAgent:"🛡",
                    WarMissileTrackerAgent:"🚀", WarFearGreedAgent:"😱", WarBTCAgent:"₿", WarSP500Agent:"📈", WarOilAgent:"🛢",
                    WarNewsAgent:"📰", WarTelegramAgent:"📡"
                };
                const AGENT_DESC = {
                    WarLMTAgent:"Lockheed Martin · Yahoo Finance",
                    WarDashboardAgent:"Dashboard Uptime Monitor", WarWorkflowManager:"Agent Health + Status Reports",
